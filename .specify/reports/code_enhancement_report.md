...
| externalized_prompts | 0 | `${WORKSPACE_ROOT}/agent-packages/agents/arr-mcp` | No prompts/ directory found. Prompts may be hardcoded in source. |
...
| agents_md | 10 | `${WORKSPACE_ROOT}/agent-packages/agents/arr-mcp/AGENTS.md` | AGENTS.md exists with comprehensive content |
| pre_commit_hooks | 10 | `${WORKSPACE_ROOT}/agent-packages/agents/arr-mcp/.pre-comm` | Pre-commit configuration found for automated code quality checks |
| gitignore | 10 | `${WORKSPACE_ROOT}/agent-packages/agents/arr-mcp/.gitignor` | .gitignore exists to prevent committing build artifacts and secrets |
| env_template | 10 | `${WORKSPACE_ROOT}/agent-packages/agents/arr-mcp/.env.exam` | Environment template exists for onboarding and secret management |
...
| Criterion | Points | Evidence | Reasoning |
|-----------|--------|----------|-----------|
| dependency_freshness | 96 | `source=${WORKSPACE_ROOT}/agent-packages/agents/arr-mcp/py` | Audited 8 deps (8 installed, 0 constraint-only). 0 major, 1 minor, 1 patch updat |
...
| Criterion | Points | Evidence | Reasoning |
|-----------|--------|----------|-----------|
| bumpversion_exists | 20 | `${WORKSPACE_ROOT}/agent-packages/agents/arr-mcp/.bumpvers` | .bumpversion.cfg found |
