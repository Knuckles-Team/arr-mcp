...
AGENT_NAME = "LidarrAgent"
AGENT_DESCRIPTION = (
    "A multi-agent system for managing Lidarr resources via delegated specialists."
)
...
SUPERVISOR_SYSTEM_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr Supervisor Agent.\n"
...
ALBUM_AGENT_PROMPT = os.environ.get(
    "ALBUM_AGENT_PROMPT",
    default=(
        "You are the Lidarr Album Agent.\n"
        "Your goal is to manage album resources.\n"
        "You have access to tools specifically tagged with 'album'.\n"
        "Use these tools to fulfill the user's request."
    ),
)

ALBUMLOOKUP_AGENT_PROMPT = os.environ.get(
    "ALBUMLOOKUP_AGENT_PROMPT",
    default=(
        "You are the Lidarr AlbumLookup Agent.\n"
        "Your goal is to manage album lookup resources.\n"
        "You have access to tools specifically tagged with 'albumlookup'.\n"
        "Use these tools to fulfill the user's request."
    ),
)

ALBUMSTUDIO_AGENT_PROMPT = os.environ.get(
    "ALBUMSTUDIO_AGENT_PROMPT",
    default=(
        "You are the Lidarr AlbumStudio Agent.\n"
        "Your goal is to manage album studio resources.\n"
        "You have access to tools specifically tagged with 'albumstudio'.\n"
        "Use these tools to fulfill the user's request."
    ),
)
...
APIINFO_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr ApiInfo Agent.\n"
...
ARTIST_AGENT_PROMPT = os.environ.get(
    "ARTIST_AGENT_PROMPT",
    default=(
        "You are the Lidarr Artist Agent.\n"
        "Your goal is to manage artist resources.\n"
        "You have access to tools specifically tagged with 'artist'.\n"
        "Use these tools to fulfill the user's request."
    ),
)

ARTISTEDITOR_AGENT_PROMPT = os.environ.get(
    "ARTISTEDITOR_AGENT_PROMPT",
    default=(
        "You are the Lidarr ArtistEditor Agent.\n"
        "Your goal is to manage artist editor resources.\n"
        "You have access to tools specifically tagged with 'artisteditor'.\n"
        "Use these tools to fulfill the user's request."
    ),
)

ARTISTLOOKUP_AGENT_PROMPT = os.environ.get(
    "ARTISTLOOKUP_AGENT_PROMPT",
    default=(
        "You are the Lidarr ArtistLookup Agent.\n"
        "Your goal is to manage artist lookup resources.\n"
        "You have access to tools specifically tagged with 'artistlookup'.\n"
        "Use these tools to fulfill the user's request."
    ),
)
...
AUTHENTICATION_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr Authentication Agent.\n"
...
AUTOTAGGING_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr AutoTagging Agent.\n"
...
BACKUP_AGENT_PROMPT = os.environ.get(
    "BACKUP_AGENT_PROMPT",
    default=(
        "You are the Lidarr Backup Agent.\n"
...
BLOCKLIST_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr Blocklist Agent.\n"
...
CALENDAR_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr Calendar Agent.\n"
...
CALENDARFEED_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr CalendarFeed Agent.\n"
...
COMMAND_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr Command Agent.\n"
...
CUSTOMFILTER_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr CustomFilter Agent.\n"
...
CUSTOMFORMAT_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr CustomFormat Agent.\n"
...
CUTOFF_AGENT_PROMPT = os.environ.get(
    "CUTOFF_AGENT_PROMPT",
    default=(
        "You are the Lidarr Cutoff Agent.\n"
...
DELAYPROFILE_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr DelayProfile Agent.\n"
...
DISKSPACE_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr DiskSpace Agent.\n"
...
DOWNLOADCLIENT_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr DownloadClient Agent.\n"
...
DOWNLOADCLIENTCONFIG_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr DownloadClientConfig Agent.\n"
...
FILESYSTEM_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr FileSystem Agent.\n"
...
HEALTH_AGENT_PROMPT = os.environ.get(
    "HEALTH_AGENT_PROMPT",
    default=(
        "You are the Lidarr Health Agent.\n"
...
HISTORY_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr History Agent.\n"
...
HOSTCONFIG_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr HostConfig Agent.\n"
...
IMPORTLIST_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr ImportList Agent.\n"
...
IMPORTLISTEXCLUSION_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr ImportListExclusion Agent.\n"
...
INDEXER_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr Indexer Agent.\n"
...
INDEXERCONFIG_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr IndexerConfig Agent.\n"
...
INDEXERFLAG_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr IndexerFlag Agent.\n"
...
LANGUAGE_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr Language Agent.\n"
...
LOCALIZATION_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr Localization Agent.\n"
...
LOGFILE_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr LogFile Agent.\n"
...
MANUALIMPORT_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr ManualImport Agent.\n"
...
MEDIACOVER_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr MediaCover Agent.\n"
...
MEDIAMANAGEMENTCONFIG_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr MediaManagementConfig Agent.\n"
...
METADATA_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr Metadata Agent.\n"
...
METADATAPROFILE_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr MetadataProfile Agent.\n"
...
METADATAPROFILESCHEMA_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr MetadataProfileSchema Agent.\n"
...
METADATAPROVIDERCONFIG_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr MetadataProviderConfig Agent.\n"
...
MISSING_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr Missing Agent.\n"
...
NAMINGCONFIG_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr NamingConfig Agent.\n"
...
NOTIFICATION_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr Notification Agent.\n"
...
PARSE_AGENT_PROMPT = os.environ.get(
    "PARSE_AGENT_PROMPT",
    default=(
        "You are the Lidarr Parse Agent.\n"
...
QUALITYDEFINITION_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr QualityDefinition Agent.\n"
...
QUALITYPROFILE_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr QualityProfile Agent.\n"
...
QUALITYPROFILESCHEMA_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr QualityProfileSchema Agent.\n"
...
QUEUE_AGENT_PROMPT = os.environ.get(
    "QUEUE_AGENT_PROMPT",
    default=(
        "You are the Lidarr Queue Agent.\n"
...
QUEUEACTION_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr QueueAction Agent.\n"
...
QUEUEDETAILS_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr QueueDetails Agent.\n"
...
QUEUESTATUS_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr QueueStatus Agent.\n"
...
RELEASE_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr Release Agent.\n"
...
RELEASEPROFILE_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr ReleaseProfile Agent.\n"
...
RELEASEPUSH_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr ReleasePush Agent.\n"
...
REMOTEPATHMAPPING_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr RemotePathMapping Agent.\n"
...
RENAMETRACK_AGENT_PROMPT = os.environ.get(
    "RENAMETRACK_AGENT_PROMPT",
    default=(
        "You are the Lidarr RenameTrack Agent.\n"
        "Your goal is to manage rename track resources.\n"
        "You have access to tools specifically tagged with 'renametrack'.\n"
        "Use these tools to fulfill the user's request."
    ),
)

RETAGTRACK_AGENT_PROMPT = os.environ.get(
    "RETAGTRACK_AGENT_PROMPT",
    default=(
        "You are the Lidarr RetagTrack Agent.\n"
        "Your goal is to manage retag track resources.\n"
        "You have access to tools specifically tagged with 'retagtrack'.\n"
        "Use these tools to fulfill the user's request."
    ),
)
...
ROOTFOLDER_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr RootFolder Agent.\n"
...
SEARCH_AGENT_PROMPT = os.environ.get(
    "SEARCH_AGENT_PROMPT",
    default=(
        "You are the Lidarr Search Agent.\n"
...
STATICRESOURCE_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr StaticResource Agent.\n"
...
SYSTEM_AGENT_PROMPT = os.environ.get(
    "SYSTEM_AGENT_PROMPT",
    default=(
        "You are the Lidarr System Agent.\n"
...
TAGDETAILS_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr TagDetails Agent.\n"
...
TRACK_AGENT_PROMPT = os.environ.get(
    "TRACK_AGENT_PROMPT",
    default=(
        "You are the Lidarr Track Agent.\n"
        "Your goal is to manage track resources.\n"
        "You have access to tools specifically tagged with 'track'.\n"
        "Use these tools to fulfill the user's request."
    ),
)

TRACKFILE_AGENT_PROMPT = os.environ.get(
    "TRACKFILE_AGENT_PROMPT",
    default=(
        "You are the Lidarr TrackFile Agent.\n"
        "Your goal is to manage track file resources.\n"
        "You have access to tools specifically tagged with 'trackfile'.\n"
        "Use these tools to fulfill the user's request."
    ),
)
...
UICONFIG_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr UiConfig Agent.\n"
...
UPDATE_AGENT_PROMPT = os.environ.get(
    "UPDATE_AGENT_PROMPT",
    default=(
        "You are the Lidarr Update Agent.\n"
...
UPDATELOGFILE_AGENT_PROMPT = os.environ.get(
    ...
    default=(
        "You are the Lidarr UpdateLogFile Agent.\n"
...
def create_agent(
    ...
    """
    logger.info("Initializing Multi-Agent System for Lidarr...")
    ...
    agent_defs = {
        "album": (ALBUM_AGENT_PROMPT, "Lidarr_Album_Agent"),
        "albumlookup": (ALBUMLOOKUP_AGENT_PROMPT, "Lidarr_AlbumLookup_Agent"),
        "albumstudio": (ALBUMSTUDIO_AGENT_PROMPT, "Lidarr_AlbumStudio_Agent"),
        "apiinfo": (APIINFO_AGENT_PROMPT, "Lidarr_ApiInfo_Agent"),
        "artist": (ARTIST_AGENT_PROMPT, "Lidarr_Artist_Agent"),
        "artisteditor": (ARTISTEDITOR_AGENT_PROMPT, "Lidarr_ArtistEditor_Agent"),
        "artistlookup": (ARTISTLOOKUP_AGENT_PROMPT, "Lidarr_ArtistLookup_Agent"),
        "authentication": (AUTHENTICATION_AGENT_PROMPT, "Lidarr_Authentication_Agent"),
        "autotagging": (AUTOTAGGING_AGENT_PROMPT, "Lidarr_AutoTagging_Agent"),
        "backup": (BACKUP_AGENT_PROMPT, "Lidarr_Backup_Agent"),
        "blocklist": (BLOCKLIST_AGENT_PROMPT, "Lidarr_Blocklist_Agent"),
        "calendar": (CALENDAR_AGENT_PROMPT, "Lidarr_Calendar_Agent"),
        "calendarfeed": (CALENDARFEED_AGENT_PROMPT, "Lidarr_CalendarFeed_Agent"),
        "command": (COMMAND_AGENT_PROMPT, "Lidarr_Command_Agent"),
        "customfilter": (CUSTOMFILTER_AGENT_PROMPT, "Lidarr_CustomFilter_Agent"),
        "customformat": (CUSTOMFORMAT_AGENT_PROMPT, "Lidarr_CustomFormat_Agent"),
        "cutoff": (CUTOFF_AGENT_PROMPT, "Lidarr_Cutoff_Agent"),
        "delayprofile": (DELAYPROFILE_AGENT_PROMPT, "Lidarr_DelayProfile_Agent"),
        "diskspace": (DISKSPACE_AGENT_PROMPT, "Lidarr_DiskSpace_Agent"),
        "downloadclient": (DOWNLOADCLIENT_AGENT_PROMPT, "Lidarr_DownloadClient_Agent"),
        "downloadclientconfig": (
            DOWNLOADCLIENTCONFIG_AGENT_PROMPT,
            "Lidarr_DownloadClientConfig_Agent",
        ),
        "filesystem": (FILESYSTEM_AGENT_PROMPT, "Lidarr_FileSystem_Agent"),
        "health": (HEALTH_AGENT_PROMPT, "Lidarr_Health_Agent"),
        "history": (HISTORY_AGENT_PROMPT, "Lidarr_History_Agent"),
        "hostconfig": (HOSTCONFIG_AGENT_PROMPT, "Lidarr_HostConfig_Agent"),
        "importlist": (IMPORTLIST_AGENT_PROMPT, "Lidarr_ImportList_Agent"),
        "importlistexclusion": (
            IMPORTLISTEXCLUSION_AGENT_PROMPT,
            "Lidarr_ImportListExclusion_Agent",
        ),
        "indexer": (INDEXER_AGENT_PROMPT, "Lidarr_Indexer_Agent"),
        "indexerconfig": (INDEXERCONFIG_AGENT_PROMPT, "Lidarr_IndexerConfig_Agent"),
        "indexerflag": (INDEXERFLAG_AGENT_PROMPT, "Lidarr_IndexerFlag_Agent"),
        "language": (LANGUAGE_AGENT_PROMPT, "Lidarr_Language_Agent"),
        "localization": (LOCALIZATION_AGENT_PROMPT, "Lidarr_Localization_Agent"),
        "log": (LOG_AGENT_PROMPT, "Lidarr_Log_Agent"),
        "logfile": (LOGFILE_AGENT_PROMPT, "Lidarr_LogFile_Agent"),
        "manualimport": (MANUALIMPORT_AGENT_PROMPT, "Lidarr_ManualImport_Agent"),
        "mediacover": (MEDIACOVER_AGENT_PROMPT, "Lidarr_MediaCover_Agent"),
        "mediamanagementconfig": (
            MEDIAMANAGEMENTCONFIG_AGENT_PROMPT,
            "Lidarr_MediaManagementConfig_Agent",
        ),
        "metadata": (METADATA_AGENT_PROMPT, "Lidarr_Metadata_Agent"),
        "metadataprofile": (
            METADATAPROFILE_AGENT_PROMPT,
            "Lidarr_MetadataProfile_Agent",
        ),
        "metadataprofileschema": (
            METADATAPROFILESCHEMA_AGENT_PROMPT,
            "Lidarr_MetadataProfileSchema_Agent",
        ),
        "metadataproviderconfig": (
            METADATAPROVIDERCONFIG_AGENT_PROMPT,
            "Lidarr_MetadataProviderConfig_Agent",
        ),
        "missing": (MISSING_AGENT_PROMPT, "Lidarr_Missing_Agent"),
        "namingconfig": (NAMINGCONFIG_AGENT_PROMPT, "Lidarr_NamingConfig_Agent"),
        "notification": (NOTIFICATION_AGENT_PROMPT, "Lidarr_Notification_Agent"),
        "parse": (PARSE_AGENT_PROMPT, "Lidarr_Parse_Agent"),
        "ping": (PING_AGENT_PROMPT, "Lidarr_Ping_Agent"),
        "qualitydefinition": (
            QUALITYDEFINITION_AGENT_PROMPT,
            "Lidarr_QualityDefinition_Agent",
        ),
        "qualityprofile": (QUALITYPROFILE_AGENT_PROMPT, "Lidarr_QualityProfile_Agent"),
        "qualityprofileschema": (
            QUALITYPROFILESCHEMA_AGENT_PROMPT,
            "Lidarr_QualityProfileSchema_Agent",
        ),
        "queue": (QUEUE_AGENT_PROMPT, "Lidarr_Queue_Agent"),
        "queueaction": (QUEUEACTION_AGENT_PROMPT, "Lidarr_QueueAction_Agent"),
        "queuedetails": (QUEUEDETAILS_AGENT_PROMPT, "Lidarr_QueueDetails_Agent"),
        "queuestatus": (QUEUESTATUS_AGENT_PROMPT, "Lidarr_QueueStatus_Agent"),
        "release": (RELEASE_AGENT_PROMPT, "Lidarr_Release_Agent"),
        "releaseprofile": (RELEASEPROFILE_AGENT_PROMPT, "Lidarr_ReleaseProfile_Agent"),
        "releasepush": (RELEASEPUSH_AGENT_PROMPT, "Lidarr_ReleasePush_Agent"),
        "remotepathmapping": (
            REMOTEPATHMAPPING_AGENT_PROMPT,
            "Lidarr_RemotePathMapping_Agent",
        ),
        "renametrack": (RENAMETRACK_AGENT_PROMPT, "Lidarr_RenameTrack_Agent"),
        "retagtrack": (RETAGTRACK_AGENT_PROMPT, "Lidarr_RetagTrack_Agent"),
        "rootfolder": (ROOTFOLDER_AGENT_PROMPT, "Lidarr_RootFolder_Agent"),
        "search": (SEARCH_AGENT_PROMPT, "Lidarr_Search_Agent"),
        "staticresource": (STATICRESOURCE_AGENT_PROMPT, "Lidarr_StaticResource_Agent"),
        "system": (SYSTEM_AGENT_PROMPT, "Lidarr_System_Agent"),
        "tag": (TAG_AGENT_PROMPT, "Lidarr_Tag_Agent"),
        "tagdetails": (TAGDETAILS_AGENT_PROMPT, "Lidarr_TagDetails_Agent"),
        "task": (TASK_AGENT_PROMPT, "Lidarr_Task_Agent"),
        "track": (TRACK_AGENT_PROMPT, "Lidarr_Track_Agent"),
        "trackfile": (TRACKFILE_AGENT_PROMPT, "Lidarr_TrackFile_Agent"),
        "uiconfig": (UICONFIG_AGENT_PROMPT, "Lidarr_UiConfig_Agent"),
        "update": (UPDATE_AGENT_PROMPT, "Lidarr_Update_Agent"),
        "updatelogfile": (UPDATELOGFILE_AGENT_PROMPT, "Lidarr_UpdateLogFile_Agent"),
    }
    ...
    @supervisor.tool
    async def assign_task_to_album_agent(ctx: RunContext[Any], task: str) -> str:
        """Assign a task related to album to the Album Agent."""
        try:

            return (
                await child_agents["album"].run(task, usage=ctx.usage, deps=ctx.deps)
            ).output

        except Exception as e:

            logger.error(f"Error in album agent: {e}", exc_info=True)

            return f"Error executing task: {e}"

    @supervisor.tool
    async def assign_task_to_albumlookup_agent(ctx: RunContext[Any], task: str) -> str:
        """Assign a task related to albumlookup to the AlbumLookup Agent."""
        try:

            return (
                await child_agents["albumlookup"].run(
            ...
            logger.error(f"Error in albumlookup agent: {e}", exc_info=True)

            return f"Error executing task: {e}"

    @supervisor.tool
    async def assign_task_to_albumstudio_agent(ctx: RunContext[Any], task: str) -> str:
        """Assign a task related to albumstudio to the AlbumStudio Agent."""
        try:

            return (
                await child_agents["albumstudio"].run(
                    task, usage=ctx.usage, deps=ctx.deps
                )
            ).output
            ...
            logger.error(f"Error in albumstudio agent: {e}", exc_info=True)
    ...
    @supervisor.tool
    async def assign_task_to_artist_agent(ctx: RunContext[Any], task: str) -> str:
        """Assign a task related to artist to the Artist Agent."""
        try:

            return (
                await child_agents["artist"].run(task, usage=ctx.usage, deps=ctx.deps)
            ).output

        except Exception as e:

            logger.error(f"Error in artist agent: {e}", exc_info=True)

            return f"Error executing task: {e}"

    @supervisor.tool
    async def assign_task_to_artisteditor_agent(ctx: RunContext[Any], task: str) -> str:
        """Assign a task related to artisteditor to the ArtistEditor Agent."""
        try:

            return (
                await child_agents["artisteditor"].run(
                    task, usage=ctx.usage, deps=ctx.deps
                )
            ).output
            ...
            logger.error(f"Error in artisteditor agent: {e}", exc_info=True)

            return f"Error executing task: {e}"

    @supervisor.tool
    async def assign_task_to_artistlookup_agent(ctx: RunContext[Any], task: str) -> str:
        """Assign a task related to artistlookup to the ArtistLookup Agent."""
        try:

            return (
                await child_agents["artistlookup"].run(
                    task, usage=ctx.usage, deps=ctx.deps
                )
            ).output
            ...
            logger.error(f"Error in artistlookup agent: {e}", exc_info=True)
    ...
    @supervisor.tool
    async def assign_task_to_renametrack_agent(ctx: RunContext[Any], task: str) -> str:
        """Assign a task related to renametrack to the RenameTrack Agent."""
        try:

            return (
                await child_agents["renametrack"].run(
                    task, usage=ctx.usage, deps=ctx.deps
                )
            ).output
            ...
            logger.error(f"Error in renametrack agent: {e}", exc_info=True)

            return f"Error executing task: {e}"

    @supervisor.tool
    async def assign_task_to_retagtrack_agent(ctx: RunContext[Any], task: str) -> str:
        """Assign a task related to retagtrack to the RetagTrack Agent."""
        try:

            return (
                await child_agents["retagtrack"].run(
                    task, usage=ctx.usage, deps=ctx.deps
                )
            ).output
            ...
            logger.error(f"Error in retagtrack agent: {e}", exc_info=True)
    ...
    @supervisor.tool
    async def assign_task_to_track_agent(ctx: RunContext[Any], task: str) -> str:
        """Assign a task related to track to the Track Agent."""
        try:

            return (
                await child_agents["track"].run(task, usage=ctx.usage, deps=ctx.deps)
            ).output

        except Exception as e:

            logger.error(f"Error in track agent: {e}", exc_info=True)

            return f"Error executing task: {e}"

    @supervisor.tool
    async def assign_task_to_trackfile_agent(ctx: RunContext[Any], task: str) -> str:
        """Assign a task related to trackfile to the TrackFile Agent."""
        try:

            return (
                await child_agents["trackfile"].run(
                    task, usage=ctx.usage, deps=ctx.deps
                )
            ).output
            ...
            logger.error(f"Error in trackfile agent: {e}", exc_info=True)
...
def agent_server():
    print(f"lidarr_agent v{__version__}")
...
def usage():
    print(
        f"Arr Mcp ({__version__}): Lidarr Agent\n\n"
        "Usage:\n"
        ...
        "Examples:\n"
        "  [Simple]  lidarr-agent \n"
        '  [Complex] lidarr-agent --host "value" --port "value" --debug "value" --reload --provider "value" --model-id "value" --base-url "value" --api-key "value" --mcp-url "value" --mcp-config "value" --custom-skills-directory "value" --web\n'
    )
