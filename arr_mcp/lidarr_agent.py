...
def create_agent(
    ...
    async def assign_task_to_albumlookup_agent(ctx: RunContext[Any], task: str) -> str:
        ...
        return (
            await child_agents["AlbumLookup"].run(task, usage=ctx.usage, deps=ctx.deps)
        ).output
    ...
    async def assign_task_to_albumstudio_agent(ctx: RunContext[Any], task: str) -> str:
        ...
        return (
            await child_agents["AlbumStudio"].run(task, usage=ctx.usage, deps=ctx.deps)
        ).output
    ...
    async def assign_task_to_artisteditor_agent(ctx: RunContext[Any], task: str) -> str:
        ...
        return (
            await child_agents["ArtistEditor"].run(task, usage=ctx.usage, deps=ctx.deps)
        ).output
    ...
    async def assign_task_to_artistlookup_agent(ctx: RunContext[Any], task: str) -> str:
        ...
        return (
            await child_agents["ArtistLookup"].run(task, usage=ctx.usage, deps=ctx.deps)
        ).output
    ...
    async def assign_task_to_renametrack_agent(ctx: RunContext[Any], task: str) -> str:
        ...
        return (
            await child_agents["RenameTrack"].run(task, usage=ctx.usage, deps=ctx.deps)
        ).output
    ...
    async def assign_task_to_retagtrack_agent(ctx: RunContext[Any], task: str) -> str:
        ...
        return (
            await child_agents["RetagTrack"].run(task, usage=ctx.usage, deps=ctx.deps)
        ).output
    ...
    async def assign_task_to_trackfile_agent(ctx: RunContext[Any], task: str) -> str:
        ...
        return (
            await child_agents["TrackFile"].run(task, usage=ctx.usage, deps=ctx.deps)
        ).output
