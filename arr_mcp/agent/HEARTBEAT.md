...
5. **Domain-Specific Checks**:
   - **Queue Status**: Check Radarr/Sonarr download queues for stalled or failed downloads.
   - **Missing Requests**: Identify highly requested media that remains missing or unavailable.
