---
name: sonarr-import-list-exclusion
description: "Generated skill for ImportListExclusion operations. Contains 7 tools."
---
...
- `post_importlistexclusion`: No description
  - **Parameters**:
    ...
    - `sonarr_api_key` (Optional[str])
    - `sonarr_verify` (bool)
- `get_importlistexclusion_paged`: No description
  - **Parameters**:
    - `page` (int)
    - `pageSize` (int)
    - `sortKey` (str)
...
- `get_importlistexclusion_id`: No description
  - **Parameters**:
    ...
    - `sonarr_api_key` (Optional[str])
    - `sonarr_verify` (bool)
- `delete_importlistexclusion_bulk`: No description
  - **Parameters**:
    - `data` (Dict)
    - `sonarr_base_url` (str)
    - `sonarr_api_key` (Optional[str])
