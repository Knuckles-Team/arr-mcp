...
|----------|----------|-------|
| `PROWLARR_BASE_URL` | ✅ | Prowlarr base URL (e.g. `[configured-endpoint]`) |
| `PROWLARR_TOKEN` | ✅ | Prowlarr API key (sent as the API token) |
| `PROWLARR_TLS_PROFILE` | optional | Runtime trust, mTLS, and proxy profile |
