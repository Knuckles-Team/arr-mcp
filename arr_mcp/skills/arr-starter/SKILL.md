...
name: arr-starter
description: >-
  Arr API + MCP Server + A2A Server Use when working with Arr via this package's MCP
...
Starter skill for the **Arr** package. Use the `mcp-client` universal skill
