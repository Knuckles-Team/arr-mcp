...
|----------|----------|-------|
| `SONARR_BASE_URL` | ✅ | Sonarr base URL (e.g. `[configured-endpoint]`) |
| `SONARR_TOKEN` | ✅ | Sonarr API key (sent as the API token) |
| `SONARR_TLS_PROFILE` | optional | Runtime trust, mTLS, and proxy profile |
