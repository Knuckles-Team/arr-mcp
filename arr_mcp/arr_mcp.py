...
mcp_config = {
    "mcpServers": {
        "chaptarr": {
            "url": os.getenv("CHAPTARR_MCP_URL", "http://localhost:8060/mcp"),
            "transport": "streamable-http",
        },
        "lidarr": {
            "url": os.getenv("LIDARR_MCP_URL", "http://localhost:8061/mcp"),
            "transport": "streamable-http",
        },
        "prowlarr": {
            "url": os.getenv("PROWLARR_MCP_URL", "http://localhost:8062/mcp"),
            "transport": "streamable-http",
        },
        "radarr": {
            "url": os.getenv("RADARR_MCP_URL", "http://localhost:8063/mcp"),
            "transport": "streamable-http",
        },
        "sonarr": {
...
def arr_mcp():
    ...
    parser = argparse.ArgumentParser(add_help=False, description="Arr MCP")
