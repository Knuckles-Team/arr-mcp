...
# Paths
ROOT_DIR = '/home/apps/workspace/agent-packages/agents/arr-mcp'
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in arr-mcp
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in arr-mcp but are NOT registered "
